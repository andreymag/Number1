...
public class FinalFour {
    public static void main(String[] args) {
        System.out.println("Отгадайте загадку!!! У вас есть 3 попытки, и право на подсказку при первой попытке." +
                "\nЕсли вы воспользовались подсказкой, то 2 и 3 попытки станут недоступны." +
                "\nЗагадка: \"Сидит дед, во сто шуб одет, кто его раздевает, тот слезы проливает\"." +
                "\nЕсли вы хотите воспользоваться подсказкой введите: Подсказка.");
